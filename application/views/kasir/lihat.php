				...
				<div class="clearfix">
					...
					<div class="float-right">
						<?php if ($this->session->login['role'] == 'admin'): ?>
							<a href="<?= base_url('kasir/export_print_lihat') ?>" class="btn btn-primary btn-sm"><i class="fa fa-print"></i>&nbsp;&nbsp;Print</a>
							<a href="<?= base_url('kasir/export_pdf_lihat') ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Download Pdf</a>
